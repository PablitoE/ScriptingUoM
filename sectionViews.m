...
classdata_file = 'D:\HoloICE\Holograms\BrightSpot\LN2\2023_01_30\melting2_C001H001S0001\contrast_ims\recon\recon_cD.mat';
% Auxiliar directory for the reconstruction
aux_dir = 'sectionViews_ratioImproved';
...
% Config file
config_file = 'D:\HoloICE\Holograms\BrightSpot\LN2\2023_01_30\melting2_C001H001S0001\contrast_ims\recon\local_win.cfg';
% Sampling in z
KzSampling = 0.5;
...
do_scaleIms = true;
scaleImsRange = [0, 0.65];  % [0,1] would mean to use the min and max of all particles to scale all the images.
save_ims = false;
...
bad_images_extract_from_plots = [15];
